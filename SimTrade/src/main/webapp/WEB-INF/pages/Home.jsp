...
<h2><!-- p>Todays Date: <%= new java.util.Date() %></p --></h2>
<form action="" method="get">
<h3 style="background-color:cyan;">Choose an action</h3>
<TABLE >
<tr>
<td><a href="http://localhost:8080/sim-details/book-a-sim" style="color: red; background-color: silver; font-family:fantasy;font-style: italic;"><h2>Book a Sim</h2></a>
</td>
</tr>
<tr>
